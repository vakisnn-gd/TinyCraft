...
copy /Y terrain.png "%IMAGE_DIR%\terrain.png" >nul
if errorlevel 1 (
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "Compress-Archive -Path '%IMAGE_DIR%\*' -DestinationPath '%RELEASE_ZIP%' -Force"
if errorlevel 1 (
